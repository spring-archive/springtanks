...
--	
	...
	EmitSfx(flares[shotfrom], muzzlesmoke)
...
function script.Killed(recentDamage, maxHealth)
	...
	Spring.UnitScript.Explode (barrels[1], SFX.FALL)
	Spring.UnitScript.Explode (barrels[2], SFX.FALL)
